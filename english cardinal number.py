...
if int(x) < 20: # numbers from 0 to 19.
    print(tupp1[int(x)]) # print number if it is lower than 20.
    ...
    print(tupp2[int(y)-2] + ' ' + tupp1[int(z)]) # print number if it is lower or equal to 99.
    ...
    if int(x)%100 < 20 and int(x)%100 != 0: # checking if there is number between 1 and 19 in 3 digits.
        ...
        print(tupp1[int(y)] + ' ' + 'hundred' + ' ' + tupp1[int(z)])
    elif int(x)%100 == 0: # checking if there is hundreds number only.
        y = int(x)/100 #to search hundreds number.
        print(tupp1[int(y)]+ ' ' + 'hundred') # print number with hundreds number only.
        ...
        print(tupp1[int(y)] + ' ' + 'hundred' + ' ' +tupp2[int(w)-2] + ' ' +tupp1[int(v)])
